...
const QMetaObject Ascot::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Ascot.data,
      qt_meta_data_Ascot,  qt_static_metacall, nullptr, nullptr}
};
